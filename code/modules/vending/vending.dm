...
/obj/machinery/vending/gunse
	...
	create_products()
		//..()
		/*
		product_list += new/datum/data/vending_product(/obj/item/gun/modular/italian/revolver/italiano, 2)
...
*/
	...
	diner
		...
		create_products()
			...
			product_list += new/datum/data/vending_product(/obj/item/gun/modular/italian/revolver/big_italiano, 2, cost = PAY_DOCTORATE)
			product_list += new/datum/data/vending_product(/obj/item/gun/modular/italian/revolver/italiano, 4, cost = PAY_TRADESMAN)
	...
	juicer
		...
		create_products()
			...
			product_list += new/datum/data/vending_product(/obj/item/gun/modular/italian/revolver/italiano, 2, cost = PAY_UNTRAINED*1.1)
