/////////// cogwerks - hideous brüllbär beast
...
/obj/critter/brullbar
	...
	attackby(obj/item/W as obj, mob/living/user as mob) //ARRRRGH WHY
		...
		if(prob(25) && alive) // crowds shouldn't be able to beat the fuck out of a confused brüllbär with impunity, fuck that
			src.target = user
