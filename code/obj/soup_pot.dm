...
/obj/item/reagent_containers/food/snacks/soup/custom
	...
	New(var/datum/custom_soup/S)
		...
		fluid_icon = image("icon" = 'icons/obj/foodNdrink/soup_pot.dmi', "icon_state" = "soup_custom-f")
...
/obj/item/soup_pot
	...
	New()
		..()
		fluid_icon = image("icon" = 'icons/obj/foodNdrink/soup_pot.dmi', "icon_state" = "souppot-f")
...
/obj/item/ladle
	...
	New()
		..()
		fluid_icon = image("icon" = 'icons/obj/foodNdrink/soup_pot.dmi', "icon_state" = "ladle-f")
		if(prob(1))
