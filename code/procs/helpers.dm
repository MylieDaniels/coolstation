...
/proc/restricted_z_allowed(var/mob/M, var/T)
	...
	if(!allowed_restricted_z_areas)
		allowed_restricted_z_areas = concrete_typesof(/area/shuttle/escape) + concrete_typesof(/area/centcom/outpost) + concrete_typesof(/area/shuttle_transit_space) + concrete_typesof(/area/football/field)
